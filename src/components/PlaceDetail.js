...
import { StarOutlined, EnvironmentOutlined, CommentOutlined } from '@ant-design/icons';
...
const PlaceDetail = ({ place, isModalVisible, setIsModalVisible }) => {
  ...
  return (
    ...
    >
      ...
      <p><StarOutlined /> Rating: {place.rating}</p>
      <p><CommentOutlined /> Description: {place.description}</p>
      <p><EnvironmentOutlined /> Address: {place.formattedAddress}</p>
